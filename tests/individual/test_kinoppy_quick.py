#!/usr/bin/env python3
"""
Kinoppy 高速 items別test
Quick Individual Test for Kinoppy (紀伊國屋書店)
"""
import sys
import json
...
class KinoppyQuickTest:
    """Kinoppy 高速testクラス"""
    
    def __init__(self):
        self.site_id = "kinoppy"
        self.site_name = "Kinoppy (紀伊國屋書店)"

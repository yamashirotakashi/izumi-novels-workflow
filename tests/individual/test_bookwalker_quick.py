#!/usr/bin/env python3
"""
BOOK☆WALKER 高速 items別test
Quick Individual Test for BOOK☆WALKER
"""
import sys
import json
...
class BookWalkerQuickTest:
    """BOOK☆WALKER 高速testクラス"""

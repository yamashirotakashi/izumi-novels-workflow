#!/usr/bin/env python3
"""
Amazon Kindle 高速 items別test
Quick Individual Test for Amazon Kindle
"""
import sys
import json
...
class AmazonQuickTest:
    """Amazon Kindle 高速testクラス"""

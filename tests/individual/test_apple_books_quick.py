#!/usr/bin/env python3
"""
Apple Books 高速 items別test
Quick Individual Test for Apple Books
"""
import sys
import json
...
class AppleBooksQuickTest:
    """Apple Books 高速testクラス"""
    
    def __init__(self):
        self.site_id = "apple_books"
        self.site_name = "Apple Books"
        self.config_path = project_root / "config" / "site_selectors.json"
    
    def run_test(self):
        """Apple Books 設定test実行"""
